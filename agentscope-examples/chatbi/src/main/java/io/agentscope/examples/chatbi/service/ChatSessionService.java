...
import io.agentscope.examples.chatbi.entity.ChatMessage;
import io.agentscope.examples.chatbi.entity.ChatSession;
import io.agentscope.examples.chatbi.mapper.ChatMessageMapper;
import io.agentscope.examples.chatbi.mapper.ChatSessionMapper;
...
public class ChatSessionService {
     ...
     * If summarized, a leading system message with summary is prepended.
     */
    ...
    /**
     * Load all messages as DTO list (for frontend history rendering).
     */
     ...
     * Strips {@code <chart>} HTML blocks before persisting.
     * {@code <report>} blocks and plain-text conclusions are preserved.
     */
    @Transactional
